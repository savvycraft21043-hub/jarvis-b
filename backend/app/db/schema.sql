...
CREATE INDEX IF NOT EXISTS idx_raw_signals_captured_at ON raw_signals(captured_at);
...
CREATE INDEX IF NOT EXISTS idx_signals_signal_time ON signals(signal_time DESC);
